...
/**
 * Вычисление суммы индексов элементов массива, равных заданному числу А
 * @param ptr_array указатель на массив
 * @param А заданное число для сравнения
 * @return сумма индексов элементов
 */
double sum_indexs(double* ptr_array, double A);
